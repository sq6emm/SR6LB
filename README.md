...
+ 2026-03-21 - beacon is UP, GPSDO replaced with eCzasPL Receiver, but it is unable to get the fix... to strong EM field for 225kHz... so beacon is running CW only - one more plan to replace eCzasPL with GPS receiver (something new like NEO-F9M) just to get a clock information, Q65 code is fixed... but as there is no clock information unable to confirm (locally tested)
